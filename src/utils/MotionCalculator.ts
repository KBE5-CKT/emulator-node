...
export class MotionCalculator {
     ...
     */
    public static calculateDistance(previous: GpsInformation, current: GpsInformation): number {
     ...
     */
    public static calculateSpeed(previous: GpsInformation, current: GpsInformation): number {
     ...
     */
    public static calculateDirection(previous: GpsInformation, current: GpsInformation): number {
        const lat1 = previous.latitude;
        const lon1 = previous.longitude;
        const lat2 = current.latitude;
        const lon2 = current.longitude;
